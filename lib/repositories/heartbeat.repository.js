...
exports.default = {
    ...
    querySafelow: function () { return __awaiter(_this, void 0, void 0, function () {
        var options, result, safeLowScaling, margin;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    safeLowScaling = 100000000;
                    margin = 1.7;
                    return [2 /*return*/, Math.ceil(result.safeLow * safeLowScaling * margin)
...
//# sourceMappingURL=heartbeat.repository.js.map